...
/// Info selengkapnya kunjungi : https://help.syncfusion.com/flutter/circular-charts/chart-types/radial-bar-chart
class CustomSfRadialChart extends StatelessWidget {
  final String title;
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: SfCircularChart(
          ...
          series: [
            RadialBarSeries<SfCircularsChart, String>(
              dataSource: data,
