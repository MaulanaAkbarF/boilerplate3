...
/// Info selengkapnya kunjungi : https://help.syncfusion.com/flutter/cartesian-charts/chart-types/area-chart
class CustomSfAreaChart extends StatelessWidget {
  final String title;
  final List<SfLineChart> data;
  final bool useXAxisAsDateTime;
  final List<Color>? listLinearGradientColor;
  final List<double>? listLinearGradientStops;
  ...
  const CustomSfAreaChart({
    super.key,
    required this.title,
    required this.data,
    this.useXAxisAsDateTime = false,
    this.listLinearGradientColor,
    this.listLinearGradientStops,
    this.xAxisTitle,
    this.yAxisTitle,
    this.containerColor,
      ...
      child: SfCartesianChart(
          ...
          series: [
            if (useXAxisAsDateTime)
              AreaSeries<SfLineChart, DateTime>(
                dataSource: data,
                xValueMapper: (SfLineChart data, _) => data.xDate ?? DateTime.now(),
                yValueMapper: (SfLineChart data, _) => data.y,
                name: title,
                gradient: listLinearGradientColor != null && listLinearGradientStops != null
                  ? LinearGradient(
                    begin: Alignment.topCenter,
                    end: Alignment.bottomCenter,
                    colors: listLinearGradientColor!,
                    stops: listLinearGradientStops!,
                  ) : LinearGradient(
                    begin: Alignment.topCenter,
                    end: Alignment.bottomCenter,
                    colors: [
                      ThemeColors.blueHighContrast(context),
                      ThemeColors.blue(context),
